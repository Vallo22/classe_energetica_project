...
@Component({
  selector: 'app-matrice-breve-st',
  templateUrl: './matrice-breve-st.component.html',
  styleUrls: ['./matrice-breve-st.component.css']
})
export class MatriceBreveStComponent implements OnInit {
  ...
  trasferisciPonderazione() {
    ...
    this.router.navigate(['/valutazione-interventi-breve-st'], {
      state: {
    ...
    this.router.navigate(['/valutazione-interventi-breve-secondario-st'], {
      state: {
        emsType: this.emsType
        , vulClass: this.vulClass
        , punteggio: this.punteggio
