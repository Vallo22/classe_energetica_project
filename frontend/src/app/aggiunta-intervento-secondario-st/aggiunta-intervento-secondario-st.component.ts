...
import { CaratteristicheStrutturaSt } from '../classes-services/classes/caratteristiche-struttura-st';
import { StrutturaSt } from '../classes-services/classes/structure/struttura-st';
import { TipoEdificioSt } from '../classes-services/classes/tipo-edificio-st';
import { AssociazioneInterventoStService } from '../classes-services/services/associazione-intervento-st.service';
import { CaratteristicheStrutturaStService } from '../classes-services/services/caratteristiche-struttura-st.service';
import { EdificioStService } from '../classes-services/services/edificio-st.service';
...
@Component({
  selector: 'app-aggiunta-intervento-secondario-st',
  templateUrl: './aggiunta-intervento-secondario-st.component.html',
  styleUrls: ['./aggiunta-intervento-secondario-st.component.css']
})
export class AggiuntaInterventoSecondarioStComponent implements OnInit {
