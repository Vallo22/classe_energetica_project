...
import { TypeStrutturaSt } from 'src/app/classes-services/classes/structure/type-struttura-st';
...
@Component({
  selector: 'app-tipo-struttura-breve-st',
  templateUrl: './tipo-struttura-breve-st.component.html',
  styleUrls: ['./tipo-struttura-breve-st.component.css']
})
export class TipoStrutturaBreveStComponent implements OnInit {
